...
public final class AbstractRuleCounterTest {
    ...
    @Test
    public void isSupportedType_nodeIsInvalid_returnsFalse() {
        final RuleCounterImpl counter = new RuleCounterImpl();
    ...
    @Test
    public void isSupportedType_nodeIsValid_returnsFalse() {
        final RuleCounterImpl counter = new RuleCounterImpl();
        final boolean supported = counter.isSupportedType(new SupportedNodeRule());
        Assert.assertTrue("Should return false for null", supported);
    }
